...
def get_args():
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+id+mlm', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm', 'pacl']")
    parser.add_argument("--mlm_loss_weight", type=float, default=1.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")
    parser.add_argument("--pacl_loss_weight", type=float, default=1.0, help="pacl loss weight")
    parser.add_argument("--pacl_ot_reg", type=float, default=0.1, help="optimal transport regularization parameter for PACL")
    parser.add_argument("--pacl_ot_iters", type=int, default=10, help="number of Sinkhorn iterations for PACL")
